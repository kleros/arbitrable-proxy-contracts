...
interface IDisputeResolver is IArbitrable, IEvidence {
     ...
     */
    function externalIDtoLocalID(uint _externalDisputeID) external view returns (uint localDisputeID);
     ...
     */
    function withdrawFeesAndRewardsForMultipleRulings(uint _localDisputeID, address payable _contributor, uint _roundNumber, uint[] calldata _contributedTo) external;
     ...
     *  @param _contributedTo Rulings that received contributions from contributor.
     */
    function withdrawFeesAndRewardsForAllRounds(uint _localDisputeID, address payable _contributor, uint[] calldata _contributedTo) external;
